...
class FeedstocksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create feedstock" do
    assert_difference('Feedstock.count') do
      post feedstocks_url, params: { feedstock: { amount: @feedstock.amount, biomass_id: @feedstock.biomass_id, unit: @feedstock.unit } }
    end
  ...
  test "should update feedstock" do
    patch feedstock_url(@feedstock), params: { feedstock: { amount: @feedstock.amount, biomass_id: @feedstock.biomass_id, unit: @feedstock.unit } }
